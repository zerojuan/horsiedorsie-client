...
{
	import com.tada.engine.resource.provider.FallbackResourceProvider;
	import com.tada.engine.resource.provider.IResourceProvider;
	...
	public class ResourceManager
	{
		...
		public function load(filename:String, resourceType:Class, onLoaded:Function = null, onFailed:Function = null, forceReload:Boolean = false):Resource
		{
			...
			if (!resource)
			{
				...
				//var fileExtension:String = GameUtil.getFileExtension(filename).toLocaleLowerCase();
