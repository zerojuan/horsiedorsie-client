package com.tada.clopclop.horseequip.HorseComponent
{
	...
	public class HorseEquipEvent extends Event {
		...
		public static const CLICKED_BOX4:String = "clickedbox4";
			...
			public function HorseEquipEvent(type:String, params:Object=null, bubbles:Boolean=false, cancelable:Boolean=false) {
