package com.tada.clopclop.test.type.dfcomponents.tab
{
	...
	public class EquipBox extends MovieClip implements IComponent
	{
		...
		private function addIconLock():void{
			_equipBox.addChild(_iconLock);
		}
		private function addIconCheck():void{
			_equipBox.addChild(_iconCheck);
		}
		private function addIconStorage():void{
			_equipBox.addChild(_iconStorage);
		}
		private function addIconLimited():void{
			_equipBox.addChild(_iconLimited);
		}
		private function addIconNew():void{
